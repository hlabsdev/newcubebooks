...
@section('content')
    ...
    <div class="content-center font-size-13 Dosis">
        <div class="pr-2 pl-2" style="border: none !important;">
            <div class="pt-3 pb-3 pl-3 pr-3" style="background-color: #137e9b;">
                <a href="{{ route('usersCubeStoreListeProduits') }}">
                    <span class="white-text">La liste des livres</span>
                </a>
            </div>
                                    ...
                                    <div class="font-size-14">
                                        ...
                                        <table class="w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td width="130">
                                                    <input type="number" name="prix_livre_papier" value="{{ $store_produit->prix_livre_papier }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                                <td width="130">
                                                    <input type="number" name="prix_usd_livre_papier" value="{{ $store_produit->prix_usd_livre_papier }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="130">
                                                    <input type="number" name="prix_livre_pdf" value="{{ $store_produit->prix_livre_pdf }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                                <td width="130">
                                                    <input type="number" name="prix_usd_livre_pdf" value="{{ $store_produit->prix_usd_livre_pdf }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="130">
                                                    <input type="number" name="prix_livre_audio" value="{{ $store_produit->prix_livre_audio }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                                <td width="130">
                                                    <input type="number" name="prix_usd_livre_audio" value="{{ $store_produit->prix_usd_livre_audio }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="130">
                                                    <input type="number" name="prix_livre_video" value="{{ $store_produit->prix_livre_video }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                                <td width="130">
                                                    <input type="number" name="prix_usd_livre_video" value="{{ $store_produit->prix_usd_livre_video }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td width="130">
                                                    <input type="number" name="prix_abonnement" value="{{ $store_produit->prix_abonnement }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                                <td width="130">
                                                    <input type="number" name="prix_usd_abonnement" value="{{ $store_produit->prix_usd_abonnement }}" placeholder="Prix" class="form-control form-control-sm mt-2 mb-2">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
