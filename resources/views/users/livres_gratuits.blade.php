            ...
            <div class="col-12">
                <div class="white mt-2" style="border: 1px solid #c2cfec;">
                    <div class="pl-2 pt-3 pb-3" style="border-bottom: 1px solid #c2cfec;">
                        <b class="font-weight-bold">CUBE BOOKS - LIVRES GRATUITS</b>
                    </div>
                    <div class="mt-2 pl-2 pr-2">
                        <div class="row">
                            <div class="col-lg-2">
                                <small><b>CUBE BOOKS - LIVRES GRATUITS</b></small>
                                            ...
                                            <div class="card z-depth-0">
                                                ...
                                                <div class="card-body pb-2 pt-2 pl-0 pr-0">
                                                    ...
                                                    <p class="card-text text-left">
                                                        <a href="{{ route('usersDownloadLivreGratutis', [$store_produit->nom, $store_produit->id]) }}" class="blue-text font-weight-bold">
                                                            Voir & Télécharger
