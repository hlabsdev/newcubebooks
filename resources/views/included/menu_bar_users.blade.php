              ...
              <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                <li class="nav-item dropdown dropdown-hover mx-2">
                  <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                    Pages
                    <img src="{{ URL::asset('assets/softui-design/img/down-arrow-dark.svg') }}" alt="down-arrow" class="arrow ms-1">
                  </a>
                        ...
                        <a class="dropdown-item py-2 ps-3 border-radius-md" href="./presentation.html">
                          <div class="d-flex">
                            ...
                            <div class="w-100 d-flex align-items-center justify-content-between">
                              ...
                              <img src="{{ URL::asset('assets/softui-design/img/down-arrow.svg') }}" alt="down-arrow" class="arrow">
                            </div>
                          </div>
                        </a>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                  <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false">
                    Docs
                    <img src="{{ URL::asset('assets/softui-design/img/down-arrow-dark.svg') }}" class="alt="down-arrow" class="arrow ms-1">
                  </a>
    ...
    <form action="" method="get" class="search-form">
        <ul class="list-inline lg-menu">
            ...
            <li class="list-inline-item mr-4">
                <a href="{{ route('indexUsers') }}">Accueil</a>
            </li>
            <li class="list-inline-item mr-4">
                <a href="{{ route('about') }}">
                    En savoir plus
            ...
            <li class="list-inline-item mr-4">
                <a href="{{ route('ListeAuteurs') }}">
                    Auteurs
                </a>
            </li>
            <li class="list-inline-item mr-4 ml-4">
                <div>
                    <table class="white" style="position: absolute; margin-top: -22px; line-height: 35px; border-radius: 3px; overflow: hidden;">
                        <tr>
                            <td>
            ...
            @foreach (User::where('id', $_COOKIE['id'])->get() as $user)
                <li class="list-inline-item float-right">
                    <div class="dropdown font-size- pt-3">
                        <a href="{{ route('uProfile') }}" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                            <div style="width: 30px; height: 30px; overflow: hidden; border: 2px solid #BBB;" class="rounded-circle white">
                        ...
                        <div class="dropdown-menu font-size-13" aria-labelledby="triggerId" style="line-height: 25px;">
                            <a class="dropdown-item text-muted" href="{{ route('uProfile') }}">Accéder à mon profil</a>
            ...
            @endforeach
            <li class="list-inline-item float-right mr-3 mt-1">
                <a href="{{ route('listNotifications') }}">
                    <i class="icofont-alarm not-icons"></i>
                    <small class="nbNotifications"></small>
                </a>
            </li>
            <li class="list-inline-item float-right mr-3 mt-1">
                <a href="{{ route('listMessages') }}">
                    <i class="icofont-envelope not-icons"></i>
                    <span id="countUnreadMessages">

                    </span>
                </a>
            </li>
            <li class="list-inline-item float-right mr-3 mt-1">
                <a href="{{ route('listPublications') }}">
                    <i class="icofont-globe-alt not-icons"></i>
                    <!--<small><span class="badge badge-pill badge-danger">2</span></small>-->
                </a>
            </li>
        </ul>
        ...
        <ul class="list-inline sm-menu">
            ...
            <!--<li class="list-inline-item float-right mt-1">
                <a href="">
                    <i class="icofont-navigation-menu not-icons"></i>
                </a>
            </li>-->
            @foreach (User::where('id', $_COOKIE['id'])->get() as $user)
                <li class="list-inline-item float-right">
                    <div class="dropdown font-size-12">
                        <a href="{{ route('uProfile') }}" id="triggerId" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                            <div style="width: 30px; height: 30px; overflow: hidden; border: 2px solid #BBB;" class="rounded-circle white mt-3">
                                @if ($user->avatar == "default.png")
                                    <a href="{{ route('uProfile') }}">
                                        <img src="{{ URL::asset('db/avatars/' . $user->avatar . '') }}" alt="img-avatr" width="100%">
                                    </a>
                        ...
                        <div class="dropdown-menu fon-size-13" aria-labelledby="triggerId" style="line-height: 25px;">
                            <a class="dropdown-item text-muted" href="{{ route('uProfile') }}">Accéder à mon profil</a>
                            <a class="dropdown-item text-muted" href="{{ route('logout') }}">
                                <i class="icofont-sign-out"></i>
                                Me déconnecter
            ...
            <li class="list-inline-item float-right mr-3 mt-1">
                <a href="{{ route('logout') }}">
                    <i class="icofont-logout not-icons"></i>
                    <!--<small><span class="badge badge-pill badge-danger">2</span></small>-->
                </a>
            </li>
            <li class="list-inline-item float-right mr-3 mt-1">
            ...
            <li class="list-inline-item float-right mr-3 mt-1">
                <a href="{{ route('allUsers') }}">
                    <i class="icofont-users not-icons"></i>
                    <!--<small><span class="badge badge-pill badge-danger">2</span></small>-->
                </a>
            </li>
        </ul>

        <div class="xm-show sub-menu z-depth-1 p-3">

            <a href="#!" class="mr-4 float-right" id="sideBarLeftSmTrigger">
                <i class="icofont-navigation-menu"></i>
            </a>

            <ul style="line-height: 30px;" class="mt-2 pl-4 font-size-14">
                <li>
                    <a href="">
