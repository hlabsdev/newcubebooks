...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ URL::asset('assets/softui-design/img/apple-icon.png') }}">
    <link rel="icon" type="image/png" href="{{ URL::asset('assets/softui-design/img/favicon.png') }}">
    <title>Soft CUBE BOOKS</title>
    <!--     Fonts and icons     -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
    <!-- Nucleo Icons -->
    <link href="{{ URL::asset('assets/softui-design/css/nucleo-icons.css') }}" rel="stylesheet" />
    <link href="{{ URL::asset('assets/softui-design/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    ...
    <link href="{{ URL::asset('assets/softui-design/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ URL::asset('assets/softui-design/css/soft-design-system.css?v=1.0.5') }}" rel="stylesheet" />
    @yield('css')
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/46/1/intl/fr_ALL/common.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/46/1/intl/fr_ALL/util.js"></script>
</head>
...
<body class="body">
    ...
    <!--   Core JS Files   -->
    <script src="{{ URL::asset('assets/softui-design/js/core/popper.min.js') }}"></script>
    <script src="{{ URL::asset('assets/softui-design/js/core/bootstrap.min.js') }}"></script>

    <!-- Plugin for the charts, full documentation here: https://www.chartjs.org/ -->
    <script src="{{ URL::asset('assets/softui-design/js/plugins/chartjs.min.js') }}"></script>
    <script src="{{ URL::asset('assets/softui-design/js/plugins/Chart.extension.js') }}"></script>

    <!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="{{ URL::asset('assets/softui-design/js/soft-ui-dashboard.min.js') }}"></script>
